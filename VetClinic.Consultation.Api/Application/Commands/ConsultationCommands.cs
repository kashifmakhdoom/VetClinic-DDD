using static VetClinic.Consultation.Domain.ValueObjects.Dose;

namespace VetClinic.Consultation.Api.Application.Commands
{
    ...
    public record SetWeightCommand(Guid ConsultationId, double Weight);
